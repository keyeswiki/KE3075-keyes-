...
在我们开始学习keyes 光线检测套件之前，首先介绍树莓派Pico主板，它是所有项目的核心。
...
![图片不存在](./media/1927bcaf00fc05dbd5a30b0f0e248570.png)
...
![图片不存在](./media/c2039799449cada6ce7fbdfb2acecc3f.png)
...
![图片不存在](./media/e8765763b6103e69dec497df42b504fc.png)
...
上一项目中我们已经学习了光敏传感器的工作原理，这一项目中我们将光敏传感器和LED灯组合实验，实现光敏传感器检测光照强度输出的ADC值大于一定值时LED快速闪烁的效果。

2. 项目元件：

|![图片不存在](./media/d12071168fd2fd07dcd66e4a187d91bd.png)|![图片不存在](./media/3eb806e0acb028c1b242da3b85c44e58.png)|![图片不存在](./media/64f4a9e4d9b86ff8b0ef8b66afabffe0.png)|![图片不存在](./media/28c28e6163de71f861c1f8f9bf621ee2.png)|
| :--: | :--: | :--: |:--: |
...
![图片不存在](./media/ae614bc224b0165d819e2d0797dd6e60.png)
...
![图片不存在](./media/94973f20a5d0c7fc3fce7e992ed336a0.png)

<span style="color: rgb(255, 76, 65);">注意：</span>代码中的阈值50000可以根据环境中实际的光照强度更改。
...
按照接线图正确接好模块和各元器件，利用MicroUSB线连接到计算机上电，单击![图片不存在](./media/4ac0a5cec03a20e095f56686af2e4c0c.png)来执行程序代码。代码开始执行，你会看到的现象是：外接LED灯不亮，同时Shell窗口中显示ADC值和"LED OFF!"；然后使用手机的照明灯对着光敏传感器模块上的光敏电阻照射，当光敏传感器检测到光照强度的ADC值大于50000时，外接LED灯快速闪烁，同时Shell窗口中显示ADC值和"LED Blinking!"。

![图片不存在](./media/326b39480a9f510cf66e2add6544a23b.jpg)
...
|adcvalue > 50000:|光照强度检测，检测到光照强度的ADC值大于50000。|
| led.value(1)  | LED灯点亮。                      |
|led.value(0) | LED灯熄灭。                      |
...
|![图片不存在](./media/d12071168fd2fd07dcd66e4a187d91bd.png)|![图片不存在](./media/3eb806e0acb028c1b242da3b85c44e58.png)|![图片不存在](./media/64f4a9e4d9b86ff8b0ef8b66afabffe0.png)|![图片不存在](./media/08cac8e036b616593db2d11a13d7922d.png)|![图片不存在](./media/28c28e6163de71f861c1f8f9bf621ee2.png)|
| :--: | :--: | :--: |:--: |:--: |
|树莓派Pico主板*1|面包板*1|光敏传感器模块*1|有源蜂鸣器模块*1|红色LED*1|
|![图片不存在](./media/dda94299cc2abaff2c9cb8ff7ce365ff.jpg)|![图片不存在](./media/a6ff46e05db89a18ffe62f2f6c66c701.png)|![图片不存在](./media/11f324f82f890b0691f134e1ea7a3765.png)| ![图片不存在](./media/8d920d12138bd3b4e62f02cecc2c63a3.png)| |
|公对母杜邦线若干|MicroUSB线*1|220Ω电阻*1|面包板连接线若干| |

3. 项目接线图：

![图片不存在](./media/a7f3e80177690b28128658d1cd110ac2.png)
...
![图片不存在](./media/76b2be97b017cbac10fba66ac19b7cc9.png)
...
按照接线图正确接好模块和各元器件，利用MicroUSB线连接到计算机上电，单击![图片不存在](./media/4ac0a5cec03a20e095f56686af2e4c0c.png)来执行程序代码。代码开始执行，你会看到的现象是：有源蜂鸣器不鸣叫，外接LED灯不亮，同时Shell窗口中显示ADC值和"Buzzer won't sound and led off!"；然后使用手机的照明灯对着光敏传感器模块上的光敏电阻照射，当光敏传感器检测到光照强度的ADC值大于50000时，有源蜂鸣器发出警报，外接LED灯快速闪烁，同时Shell窗口中显示ADC值和“Buzzer sounds and led blinking!”。

![图片不存在](./media/71dba63ac8b4a74b20ee9f2fd2a4a536.jpg)
